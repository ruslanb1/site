...
(function() {
    ...
    var GGBApplet = function() {
        ...
        var setDefaultHTML5CodebaseForVersion = function(version, offline) {
            ...
            if (index > 0) {
                ...
                codebase = "https://www.geogebra.org/apps/5.2.902.0/"
            }
    ...
    GGBAppletUtils.makeModule = function(name, permutation) {
        function webModule() {
            ...
            A();
            webModule.__moduleBase = "https://www.geogebra.org/apps/5.2.902.0/" + name + "/";
    ...
    if (typeof window.web3d !== "function") {
        window.web3d = GGBAppletUtils.makeModule("web3d", "F53FE8BEA7AD8AA8B3471691A5855129")
    }
    if (typeof window.webSimple !== "function") {
        window.webSimple = GGBAppletUtils.makeModule("webSimple", "455074C58222430256F53176A4B9988B")
    }
