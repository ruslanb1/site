...
function flowLine_head(x1, y1, x2, y2, head, isStart)
{
    ...
    let d1 = head/2;                // 파선 시작 지점
    let d2 = head;                  // 파선의 한주기 길이
...
// drawArrow2 를 주력으로 사용 (head 권장값: 10)
...
// drawBothArrow2 를 주력으로 사용 (head 권장값: 10)
...
// draw2DArrow2 를 주력으로 사용 (thick 권장값: 4 ~ 6)
